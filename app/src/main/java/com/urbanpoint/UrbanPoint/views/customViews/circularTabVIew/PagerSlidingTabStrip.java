...
package com.urbanpoint.UrbanPoint.views.customViews.circularTabVIew;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xffff00ff;
    ...
    private int tabTextColorSelected = 0xff0000ff;
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle = Typeface.NORMAL;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.custom_round_button;
    private int tabBackgroundResIdSelected = R.drawable.round_tabs_custom;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setOrientation(LinearLayout.HORIZONTAL);//#631128
        //tabsContainer.setBackgroundColor(Color.parseColor("#631128"));
        ...
        tabBackgroundResIdSelected = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsTabBackground, tabBackgroundResIdSelected);
    ...
    private void addTab(final int position, View tab) {
        ...
        for (int i = 0; i < tabsContainer.getChildCount(); i++) {
            ...
            tabsContainer.getChildAt(i).setSelected(position == i);

            if ((0 == i)) { // position = 0,1
                View v = tabsContainer.getChildAt(i);
                v.setBackgroundResource(tabBackgroundResId);
                TextView title = (TextView) tabsContainer.getChildAt(i);
                title.setTextColor(tabTextColorSelected);

            } else {

                View v = tabsContainer.getChildAt(i);
                v.setBackgroundResource(tabBackgroundResIdSelected);
                TextView title = (TextView) tabsContainer.getChildAt(i);
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            Log.v("current tab", currentPosition + "");
